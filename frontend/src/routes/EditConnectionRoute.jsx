      ...
      <div className="p-8 flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="pt-6 text-center">
            <h2 className="text-2xl font-bold text-destructive mb-4">Connection Not Found</h2>
            <p className="text-muted-foreground mb-6">The connection you are trying to edit does not exist.</p>
            <Button
              onClick={() => navigate('/')}
              className="w-full"
            >
    ...
    <div className="p-8">
      ...
      >
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle className="text-2xl">Edit Connection</CardTitle>
          </CardHeader>
          <CardContent>
